...
sims = read.csv("C:/Users/James Stroud/Dropbox/Anolis selection study/Miami_landscape_paper/manuscript_figs/null_model/null_model_10k_sim_july2021.csv")
str(sims)
#simulations were conducted 15-17th July 2021
...
total.sims = 10000
binom.mod = binom.test(similar.sims, total.sims, p = 0.05,
                       alternative = c("two.sided", "less", "greater"),
                       conf.level = 0.95)
#1-probability of success
1-binom.mod$estimate
#binomial model p-value
binom.mod$p.value
binom.mod
